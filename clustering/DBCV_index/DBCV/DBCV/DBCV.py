...
def _mutual_reach_dist_MST(dist_tree):
    ...
    """
    mst = minimum_spanning_tree(dist_tree,overwrite=True).toarray()
    trans_mst = mst + np.transpose(mst)
    # scipy.io.savemat('clustering/DBCV_index/DBCV/DBCV/MST.mat', {'MST_py': mst, 'trans_MST_py':trans_mst})
    return trans_mst
